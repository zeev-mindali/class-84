...
<body>
    <form action="../controller-layer/donation-controller.php" , method="post">
        <h2>add donation</h2>
        <label>name:</label>
        ...
        <select name="payment_type">
            <?php
            require_once '../business-logic-layer/donation-logic.php';
        ...
        <tbody>
            ...
            foreach ($donations as $item){
                echo "<tr>"
                    ...
                    . "<td>$item->payment</td>"
                    . "<td>$item->memo</td>"
                    . "<td><button name='id' value='$item->id'>X</button></td>"
                    . "</tr>";
            }
            ?>
        </tbody>
